...
export declare function findByConf(
  item: any,
  conf: IFilterMode | IFilterCallback
): any;
...
export declare function toDataDriver(
  driver: DataDriver | IDataDriver
): IDataDriver;
export declare function copyWithoutInner(
  obj: IAnyObj,
  forbidden?: IAnyObj
): IAnyObj;

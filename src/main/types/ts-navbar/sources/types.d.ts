...
import { UploaderEvents } from '../../ts-vault/sources/types';
...
export interface INavbarConfig {
  ...
  css?: string;
  menuCss?: string;
  data?: INavItem[] | TreeCollection<INavItem>;
  rootId?: string;
}
export interface INavbar {
  data: TreeCollection;
  events: IEventSystem<
    DataEvents | NavigationBarEvents,
    IDataEventsHandlersMap & INavbarEventHandlersMap
  >;
...
export declare type IMenuElement =
  | ISpacer
  | ISeparator
  | INavItem
  | IMenuItem
...
export declare type NavigationBarEventsStrings =
  keyof typeof NavigationBarEvents;
export type INavbarEventHandlersMap = {
  [key in NavigationBarEventsStrings]: (...args: never[]) => never;
} & {

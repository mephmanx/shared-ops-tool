...
export declare type fixedRowContent =
  | 'inputFilter'
  | 'selectFilter'
  | 'comboFilter';
...
export interface IEventHandlersMap {
  ...
  [GridEvents.filterChange]: (
    value: string,
    colId: Id,
    filterId: fixedRowContent
  ) => void;
  ...
  [GridEvents.headerCellMouseDown]: (
    col: ICol,
    e: MouseEvent & TouchEvent
  ) => void;
  [GridEvents.footerCellMouseDown]: (
    col: ICol,
    e: MouseEvent & TouchEvent
  ) => void;
  ...
  [GridEvents.beforeEditStart]: (
    row: IRow,
    col: ICol,
    editorType: EditorType
  ) => boolean | void;
  [GridEvents.afterEditStart]: (
    row: IRow,
    col: ICol,
    editorType: EditorType
  ) => void;
  [GridEvents.beforeEditEnd]: (
    value: string | number | boolean,
    row: IRow,
    col: ICol
  ) => boolean | void;
  [GridEvents.afterEditEnd]: (
    value: string | number | boolean,
    row: IRow,
    col: ICol
  ) => void;
  ...
  [GridEvents.beforeRowResize]: (
    row: IRow,
    events: Event,
    currentHeight: number
  ) => boolean;
  [GridEvents.afterRowResize]: (
    row: IRow,
    events: Event,
    currentHeight: number
  ) => void;
...
export interface ISystemEventHandlersMap {
  [key: string]: (...args: any[]) => any;
  [GridSystemEvents.cellTouchMove]: (
    row: IRow,
    col: ICol,
    e: TouchEvent
  ) => void;
  [GridSystemEvents.cellTouchEnd]: (
    row: IRow,
    col: ICol,
    e: TouchEvent
  ) => void;
...
export interface IGridSelectionEventsHandlersMap {
  ...
  [GridSelectionEvents.beforeUnSelect]: (
    row: IRow,
    col: ICol
  ) => boolean | void;
}

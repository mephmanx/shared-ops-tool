...
export declare function eventHandler(
  ...
  hash: IHandlerHash,
  afterCall?: anyFunction
): (ev: Event) => boolean;
export declare function locateNode(
  target: Event | Element,
  attr?: string,
  dir?: string
): Element;
export declare function locate(target: Event | Element, attr?: string): string;
export declare function locateNodeByClassName(
  target: Event | Element,
  className?: string
): Element;
...
export declare function fitPosition(
  node: HTMLElement,
  config: IFitPositionConfig
): {
  left: string;
...
export declare function getLabelStyle(config: any):
  | false
  | {
      style: {
        width: any;
